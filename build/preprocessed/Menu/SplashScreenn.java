 ...
 * @author maher
 */
public class SplashScreenn extends Canvas implements Runnable{
     ...
     */
    public SplashScreenn(Midlet Midlet){
        this.Midlet = Midlet;
        try{
        mImage = Image.createImage("/Images/splash2.jpg");
    ...
    public void dismiss() {
        if (isShown())
            Display.getDisplay(Midlet).setCurrent(new SplashScreen(Midlet));
